...
export async function onRequest(context) {
    try {
        ...
        const posts = await fetchAllPosts(context.env.GITHUB_TOKEN);
...
function generateIndexHTML(posts) {
    const latestPosts = posts.slice(0, 12); // Show latest 12 posts
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="search-box">
                <input type="text" id="searchInput" placeholder="Search for product reviews...">
    ...
    <main class="main-content">
        <div class="container">
            <div class="content-wrapper">
                <h2 class="section-title" id="reviews">Latest Product Reviews</h2>
                ...
                ${latestPosts.length > 12 ? `
                    <div style="text-align: center; margin-top: 2rem;">
                        <button onclick="loadMorePosts()" style="background: var(--primary); color: white; border: none; padding: 1rem 2rem; border-radius: var(--radius); cursor: pointer;">
                            Load More Reviews
                        </button>
                    </div>
                ` : ''}
